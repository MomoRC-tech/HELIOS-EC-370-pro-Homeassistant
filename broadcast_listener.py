                ...
                while made_progress:
                    ...
                    if generic:
                        ...
                        try:
                            ...
                            elif var == HeliosVar.Var_47_filter_remaining_time and vals:
                                self.coord.update_values({"filter_remaining_time": int(vals[0])})
        ...
        while not self.stop_event.is_set():
            ...
            if not startup_done:
                for var in (
                    ...
                    HeliosVar.Var_47_filter_remaining_time,
